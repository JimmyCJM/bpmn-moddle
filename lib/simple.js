...
export default class SimpleBpmnModdle extends BpmnModdle {

  constructor(additionalPackages, options) {

    const packages = assign({}, defaultPackages, additionalPackages);
